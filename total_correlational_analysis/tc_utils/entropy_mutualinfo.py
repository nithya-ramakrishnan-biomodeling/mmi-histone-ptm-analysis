...
# total correlation mutual information calculation.
def total_correlation(arr1: np.array, arr2: np.array, arr3: np.array, spaced_bin_edges):
    """Calculate the total correlation between three variables.
