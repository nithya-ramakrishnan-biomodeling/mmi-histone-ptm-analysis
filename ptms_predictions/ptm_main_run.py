...
parser = argparse.ArgumentParser(description="Run histone modification prediction pipeline")
...
for organism in organism_list:
    ...
    command = [
        "python",
        os.path.join(project_dir_name, "r2_prediction_omp_based_xgb_n_number_feature.py"),
        "-o", organism,
        "-n", "8",  # Default number of features to select
    ]
