...
parser = argparse.ArgumentParser(
    description="R² prediction using PCA transformed features"
)
parser.add_argument(
    "-o",
    "--organism",
...
parser.add_argument(
    ...
    type=str,
    default="mi",
    help="Method used (mi or cov) (default: mi)",
)
parser.add_argument(
    "-p",
    "--parallel",
...
parser.add_argument(
    ...
    type=int,
    default=-2,
    help="Number of parallel jobs if using parallel mode (default: -2)",
)
...
if __name__ == "__main__":
    ...
    output_r2_file_path = os.path.join(
        output_dir_full_path, f"{organism}_{method}_pca_r2.json"
    )
