...
class PlotValidator:
    ...
    def validate_colors(colors: List[str], data_length: int) -> bool:
        ...
        if len(colors) < data_length:
            raise ValueError(f"Not enough colors ({len(colors)}) for data points ({data_length})")
        return True
...
class BarGraphColorPalette:
    ...
    MULTI = {
        ...
        'dark': ['#1b1b1b', '#242424', '#2d2d2d', '#363636', '#3f3f3f',
                '#484848', '#515151', '#5a5a5a', '#636363', '#6c6c6c'],
    }
    ...
    PUBLICATION = {
        ...
        'nejm': ['#BC3C29', '#0072B5', '#E18727', '#20854E', '#7876B1', '#6F99AD'],  # New England Journal
        'lancet': ['#00468B', '#ED0000', '#42B540', '#0099B4', '#925E9F', '#FDAF91'],  # Lancet
        'jama': ['#374E55', '#DF8F44', '#00A1D5', '#B24745', '#79AF97', '#6A6599'],  # JAMA
        'pnas': ['#FF9900', '#109618', '#990099', '#3B3EAC', '#0099C6', '#DD4477'],  # PNAS
    }
    
    # Colorblind-friendly schemes
    COLORBLIND = {
        'wong': ['#000000', '#E69F00', '#56B4E9', '#009E73', '#F0E442', 
                '#0072B2', '#D55E00', '#CC79A7'],  # Wong's palette
        'okabe_ito': ['#E69F00', '#56B4E9', '#009E73', '#F0E442', '#0072B2',
                      '#D55E00', '#CC79A7', '#000000'],  # Okabe-Ito
        'tol': ['#332288', '#88CCEE', '#44AA99', '#117733', '#999933',
                '#DDCC77', '#CC6677', '#882255', '#AA4499'],  # Paul Tol's
    }
    ...
    @staticmethod
    def create_emphasis_palette(highlight_positions: List[int], 
                              n_bars: int,
                              highlight_color: str = '#FF0000',
                              base_color: str = '#E6E6E6') -> List[str]:
    ...
    @staticmethod
    def create_gradient_palette(start_color: str,
                              end_color: str,
        ...
        # Create gradient
        colors = [
            tuple(r1 + (r2 - r1) * i / (n_colors - 1) 
                  for r1, r2 in zip(rgb1, rgb2))
...
if __name__ == "__main__":
    ...
    config_with_errors = BarGraphConfig(
        error_bar_style='band',
        show_values=True
    )
