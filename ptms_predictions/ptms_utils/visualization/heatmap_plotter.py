...
class PlotValidator:
    ...
    def validate_labels(labels: List[str], size: int) -> bool:
        ...
        if len(labels) != size:
            raise ValueError(f"Number of labels ({len(labels)}) does not match data size ({size})")
        return True
...
class HeatmapColorPalette:
    ...
    SEQUENTIAL = {
        ...
        'inferno': ['#000004', '#320A5A', '#781C6D', '#BC3754', '#ED6925', '#FBB41A', '#FCFFA4'],
        'cividis': ['#00204C', '#213D6B', '#555B6C', '#7B7B78', '#A59C74', '#D6C271', '#FFE945']
    }
    ...
    DIVERGING = {
        ...
        'spectral': ['#9E0142', '#D53E4F', '#F46D43', '#FFFFBF', '#66C2A5', '#3288BD', '#5E4FA2'],
    ...
    SPECIAL = {
        ...
        'correlation': ['#001F3F', '#0074D9', '#7FDBFF', '#FFFFFF', '#FF851B', '#FF4136', '#85144B'],
        'correlation_simple': ['#3B9AB2', '#FFFFFF', '#E31A1C'],
        
        # Expression data
        'expression': ['#00441B', '#1B7837', '#5AAE61', '#FFFFFF', '#DFC27D', '#BF812D', '#8C510A'],
        'expression_binary': ['#2166AC', '#FFFFFF', '#B2182B'],
        
        # P-value visualization
        'pvalue': ['#FFFFFF', '#FEE0D2', '#FC9272', '#DE2D26'],
        'significance': ['#FFFFFF', '#FFF5F0', '#FEE0D2', '#FCC5C0', '#FA9FB5', '#F768A1', '#DD3497', '#AE017E', '#7A0177']
    }
    
    @staticmethod
    def create_custom_cmap(colors: List[str], 
                          name: str = 'custom',
    ...
    @staticmethod
    def get_scale_normalizer(data: np.ndarray,
                           vmin: Optional[float] = None,
                           vmax: Optional[float] = None,
                           center: Optional[float] = None,
                           robust: bool = False) -> Normalize:
    ...
    @staticmethod
    def create_sequential_gradient(start_color: str, end_color: str, n_colors: int = 256) -> List[str]:
    ...
    def plot_heatmap(self,
        ...
        try:
            ...
            cmap = HeatmapColorPalette.create_custom_cmap(
                palette, 
                scheme, 
                reverse=self.config.cmap_reverse
            )
