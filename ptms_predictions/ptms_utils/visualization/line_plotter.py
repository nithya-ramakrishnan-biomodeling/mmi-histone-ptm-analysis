...
class LineColorPalette:
    ...
    R2_SPECIFIC = {
        ...
        'evaluation': ['#4e79a7', '#f28e2c', '#e15759', '#76b7b2', '#59a14f', '#edc949'],
    ...
    ACCESSIBLE = {
        ...
        'deuteranopia': ['#000000', '#E69F00', '#56B4E9', '#009E73', '#F0E442', '#0072B2'],
        'protanopia': ['#000000', '#E69F00', '#56B4E9', '#009E73', '#CC79A7', '#0072B2'],
        'tritanopia': ['#000000', '#E69F00', '#56B4E9', '#009E73', '#F0E442', '#D55E00']
    }
    
    # Specialized statistical palettes
    STATISTICAL = {
        'p_values': ['#FFFFFF', '#FEE0D2', '#FC9272', '#DE2D26'],
        'correlation': ['#67001F', '#B2182B', '#F4A582', '#FFFFFF', '#92C5DE', '#2166AC'],
        'significance': ['#FFFFFF', '#FFF5F0', '#FEE0D2', '#FCC5C0', '#FA9FB5', '#F768A1', '#DD3497', '#AE017E'],
        'regression': ['#4A148C', '#7B1FA2', '#E1BEE7', '#F5F5F5', '#B3E5FC', '#01579B']
    }
    ...
    def plot_lines(self,
        ...
        try:
            ...
            for idx, (line_name, (x_values, y_values)) in enumerate(data.items()):
                ...
                if self.config.show_annotations and annotations and line_name in annotations:
...
if __name__ == "__main__":
    ...
    annotations = {
        'Sin': ['max' if i == np.argmax(y1) else 'min' if i == np.argmin(y1) else ''
